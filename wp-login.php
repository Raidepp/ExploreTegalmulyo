...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Explore Tegalmulyo &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.1.1" media="all">
	...
	<link rel="icon" href="./wp-content/uploads/2023/01/cropped-fix-no-bg-32x32.png" sizes="32x32">
<link rel="icon" href="./wp-content/uploads/2023/01/cropped-fix-no-bg-192x192.png" sizes="192x192">
<link rel="apple-touch-icon" href="./wp-content/uploads/2023/01/cropped-fix-no-bg-180x180.png">
<meta name="msapplication-TileImage" content="./wp-content/uploads/2023/01/cropped-fix-no-bg-270x270.png">
	</head>
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/exploretegalmulyo/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/exploretegalmulyo/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to Explore Tegalmulyo</a>		</p>
			</div>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"bb46b49f9c"};</script>
